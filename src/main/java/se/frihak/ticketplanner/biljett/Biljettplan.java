...
public class Biljettplan extends TicketplannerBase
{
	...
	public List<Biljettplan> planera(Resa resa, Properties props)
	{
		...
		//Kolla om denna plan redan har en giltig biljett. Om ja, så returneras denna plan
		if (biljetter.size() > 0)
		{
			Biljett biljett = (Biljett)biljetter.get(biljetter.size()-1);
	...
	/**
	 * Hämtar biljettplanens totalpris, adderat av tidigare planer samt alla biljetter.
	 * @return Price
	 */
	public int getPrice()
	{
